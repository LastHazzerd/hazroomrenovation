...
namespace hazroomrenovation.source.Systems {
    ...
    public class RenRoom : Room {
        ...
        ///// <summary> The number of times the search traversed outside the maxSize bounding box. 
        ///// </summary>
        ...
        ///// <summary> The number of wall blocks that are considered temperature retaining/insulating inside the room. 
        ///// </summary>
        //public new int CoolingWallCount;
        ///// <summary> the number of wall blocks that are not considered temperature retaining/insulating inside the room. 
        ///// </summary>
        ...
        /// <summary> number of blocks making up the walls/floor/ceiling that can be considered solid or insulating. 
        /// </summary>
        public int EnclosingBlockCount;
        /// <summary> number of blocks making up the walls/floor/ceiling can NOT be considered solid or insulating. 
        /// </summary>
